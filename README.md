# A little front-end for ["The Open Movie Database"](http://www.omdbapi.com/) *- search for movie titles and info! -* Online at: [movie-searcher-site.netlify.app](https://movie-searcher-site.netlify.app)
